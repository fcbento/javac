...
public class CustomApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "403.312.698-80", TipoCliente.PESSOA_FISICA);
        cli1.getTelefones().addAll(Arrays.asList("46578893", "45646581"));
